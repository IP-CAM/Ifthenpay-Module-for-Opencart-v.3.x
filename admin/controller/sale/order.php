		...
		if ($order_info) {
			...
			foreach ($vouchers as $voucher) {
				$data['vouchers'][] = array(
					...
					'amount'      => $this->currency->format($voucher['amount'], $order_info['currency_code'], $id="history"['currency_value']),
			...
			//add javascript to remove <br> from history table
			$this->document->addScript('view/javascript/ifthenpayPayshop.min.js');
